...
class BufferPlus {
    ...
    moveTo(position) {
        ...
        if (position < 0 || position > 0 && position > this._len) throw new RangeError('position must be between 0 to length');
        this._pos = position;
    }
    ...
    skip(offset) {
        ...
        if (position < 0 || position > this._len) throw new RangeError('skip position must be between 0 to length');
    ...
    readString(a1, a2) {
        ...
        if (typeof a1 === 'number') length = a1;else if (typeof a1 === 'string') encoding = a1;else if (typeof a2 === 'string') encoding = a2;
